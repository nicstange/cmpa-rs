...
#[derive(Clone, Copy)]
pub struct ZeroizeableSubtleChoice(pub subtle::Choice);

impl ops::Deref for ZeroizeableSubtleChoice {
    type Target = subtle::Choice;
...
impl default::Default for ZeroizeableSubtleChoice {
    fn default() -> Self {
        ZeroizeableSubtleChoice(subtle::Choice::from(0))
    }
}

#[cfg(feature = "zeroize")]
impl zeroize::DefaultIsZeroes for ZeroizeableSubtleChoice {}
